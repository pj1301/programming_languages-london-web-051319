...
def reformat_languages(languages)
  # your code here
  # languages_by_style.collect do |tier_one, tier_two|
  #   languages_by_style.invert
  # take out of original and put into a new one
  # new_hash = languages_by_style.collect do |tier_one, tier_two|
  #   languages_by_style[tier_one].collect do |tier_two, tier_three|
  #     {tier_two => tier_three}
  ...
  new_hash.each do |tier_one, tier_two|
    ...
    if array_two.include?(tier_one)
      ...
      # binding.pry
      #  yet_another_hash[tier_one] = {:style => [:functional]}
      # new_hash[tier_one].merge(:style => [:functional])
    end
  end
  
  # a = new_hash.merge!(another_hash) {|tier_one, v1, v2| v1}
...
# new_hash.each do |tier_one, tier_two|
#   if array_one.include?(tier_one)
#     # new_hash[tier_one] << {:style => [:oo]}
#     # new_hash.merge!({:style => [:oo]})
#     another_hash[tier_one] = {:style => [:oo]}
#   end
#   if array_two.include?(tier_one)
#      yet_another_hash[tier_one] = {:style => [:functional]}
